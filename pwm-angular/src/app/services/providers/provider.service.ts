...
import { NewsFirebaseServiceInterface } from './firebase/interfaces/news-firebase-service.interface';
import { NewsFirebaseService } from './firebase/news.firebase.service';
import { db } from '../../../environments/firebase.config';
import { UserFirebaseServiceInterface } from './firebase/interfaces/user-firebase-service.interface';
import { UserFirebaseService } from './firebase/user.firebase.service';
import { CommentFirebaseServiceInterface } from './firebase/interfaces/comment-firebase-service.interface';
...
import { AuthFirebaseServiceInterface } from './firebase/interfaces/auth-firebase-service.interface';
